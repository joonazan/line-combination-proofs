...
Round Elimination is a process used to study the hardness of distributed graph problems.
It can be tedious or downright impossible to perform by hand, as it can multiply the size of its input and has to be applied multiple times in sequence.
